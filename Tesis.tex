...
%subrayar con líneas de puntos
\usepackage[normalem]{ulem}
%\normalem
%listas enumeradas con romanos
\usepackage{enumerate}


%para enriquecer las tablas
\usepackage{tabularx} %row style
%Para poner color a la letra en tablas
%\newcommand*{\@rowstyle}{}
...
%----------------
%\usepackage{array, arydshln} %problemas en linux, no en mac. Como causa además otros problemas queda fuera. 
%este paquete para pintar lineas discontinuas tiene que añadirse 
%después de longtable y tabularx. Tabularx he tenido que añadirlo para
%que reconozca el arydshln, desconozco su utilidad.
...
constantes,guionado,Cascaras/bibliografia,config,shortcuts%
}
...
%Para dibujar diagramas uml/network messages
\usepackage{tikz}
...
\include{Capitulos/02State}
\include{Capitulos/03Analysis}
\include{Capitulos/04Design}
\include{Capitulos/05Implementation}
\include{Capitulos/06Conclusions}
\include{Capitulos/07FutureActions}
