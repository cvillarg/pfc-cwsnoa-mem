...
Podemos clasificar la \ac{CR} dependiendo de la zona de operación y de las características que tenga. En esta primera clasificación podemos distinguir:
\begin{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textit{Algoritmos genéticos}, siempre que se habla de aprendizaje en máquinas e inteligencia artificial surge el término de redes neuronales. Si la respuesta de la red se puede modelar como un patrón de ruido, una red neuronal puede ayudar para clasificar y reconocer este patrón dadas unas respuestas predeterminadas. Este tipo de algoritmos funcionan mejor cuando el proceso está centralizado y se conocen bastantes detalles del mismo.
