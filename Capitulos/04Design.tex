...
%%diseño+impletacion
\comp{D+I:
Este envío se realiza gracias a otra asynTask que al finalizar libera los recursos del controlador cerrando la vida de la aplicación por completo.
}
%%--
...
%------------------------------
\subsection{Sensado del entorno y política cognitiva}
